...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--no_features_scaling', action='store_true', default=False,
                        help='Turn off scaling of features')
    parser.add_argument('--wd', type=float, default=1e-4, help='Weight decay in optimizer')
    ...
    parser.add_argument('--dropout1', type=float, default=0.3,
                        help='Dropout probability for the first encoder')
    parser.add_argument('--dropout2', type=float, default=0.3,
                        help='Dropout probability for the second encoder')
    ...
    parser.add_argument("--exp_id", default="", type=str, required=True,
                        help="Experiment ID")
    parser.add_argument("--step", default="pretrain", type=str,
                        choices=['pretrain', 'finetune', 'finetune_add', 'finetune_concat'],
